...
| `appropriate-comments-code` | `appropriate-comments-code` | The full comment discipline — six tenets, the review-a-diff procedure with labels, the ratio check, and the test-file rules — run over the merged diff at step 8 | `appropriate-comments-fallback.md` |
